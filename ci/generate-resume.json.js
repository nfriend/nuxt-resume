...
async function updateGitLabSnippet({ pat, snippetId, stringifiedResumeJson }) {
  await request.put({
    ...
    body: {
      ...
      description:
        'My [`resume.json`](https://jsonresume.org/). This file is automatically generated by the CI pipeline of my [Nuxt Résumé project](https://gitlab.com/nfriend/nuxt-resume#resumejson). View a rendered version of this data [here](https://registry.jsonresume.org/nfriend).',
